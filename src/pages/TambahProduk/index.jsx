...
import { Container, Header, Icon, Card, Form, Dropdown, Input } from 'semantic-ui-react';
...
function TambahProduk(props) {
	...
	function addBarang() {
		if (context.getPengguna().usaha) {
			axios
				.post(`http://localhost:8000/usaha/${context.getPengguna().usaha.id_usaha}/produk`, input, {
					headers: {
				...
				<Card.Content>
					<div style={styles.card}>
						<Form size="large">
							...
							<Form.TextArea label="Deskripsi Produk" placeholder="Deskripsi produk anda..." />
							<Form.Input
								label="Gambar Produk"
								type="file"
