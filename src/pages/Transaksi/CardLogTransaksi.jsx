...
import { Container, Accordion, Icon, Grid, Header, Button } from 'semantic-ui-react';
						...
						<Grid.Row>
							<Grid.Column width={7}>
								<Header>
									...
									<Header.Content style={styles.h2}>123sadasddasdadaasd</Header.Content>
								</Header>
							</Grid.Column>
							<Grid.Column width={5}>
								<Header>
							...
							<Grid.Column width={4} textAlign="center">
								<Button color="green" size="huge" style={{ margin: '10px' }}>
									Diterima
								</Button>
							</Grid.Column>
						</Grid.Row>
